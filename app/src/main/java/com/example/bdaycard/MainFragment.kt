...
class MainFragment : Fragment(R.layout.fragment_main), Balloon.BalloonListener {
...
//        setContentView(R.layout.activity_main)
        ...
        mContentView = view?.findViewById<View>(R.id.fragment_main) as ViewGroup
    ...
    override fun onResume() {
        ...
        val path = "android.resource://" + activity?.packageName + "/" + R.raw.orange
        //specify the location of media file
...
//              Wait a random number of milliseconds before looping
    ...
    private fun launchBalloon(x: Int) {
        val balloon = context?.let { Balloon(it, mBalloonColors[mNextColor], 150) }
        if (balloon != null) {
